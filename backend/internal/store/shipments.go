...
INSERT INTO shipments (
    ...
    status, last_event, last_event_at, estimated_delivery, delivered_at,
    last_synced_at, health, idle_since, risk_score, created_at, updated_at
) VALUES (
    $1, $2, $3, $4, $5, $6,
    COALESCE($7, 'created'), $8, $9, $10, $11,
    $12, COALESCE($13, 'unknown'), $14, COALESCE($15, 0), NOW(), NOW()
)
...
RETURNING id;`
	...
	err := r.Pool.QueryRow(ctx, q,
		...
		s.Status, s.LastEvent, s.LastEventAt, s.EstimatedDelivery, s.DeliveredAt,
		s.LastSyncedAt, s.Health, s.IdleSince, s.RiskScore,
	).Scan(&id)
	if err != nil {
...
FROM shipments WHERE id = $1`
	...
	err := r.Pool.QueryRow(ctx, q, id).Scan(
		...
		&s.Status, &s.LastEvent, &s.LastEventAt, &s.EstimatedDelivery, &s.DeliveredAt,
		&s.LastSyncedAt, &s.Health, &s.IdleSince, &s.RiskScore, &s.CreatedAt, &s.UpdatedAt,
	)
